    ...
    <body class="antialiased">
        <header class="text-gray-600 body-font">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <a class="mr-5 hover:text-gray-900" href="{{ url('/') }}">Pendaftaran</a>
                <a class="mr-5 hover:text-gray-900" href="{{ url('/') }}">Pertanyaan</a>
                </nav>
                <button class="inline-flex items-center ring-1 ring-gray-300 bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Login
